...
$(TRAIN_TARGET): $(BUILD_DIR)/nn/train.o $(BUILD_DIR)/nn/CNN.o $(BUILD_DIR)/nn/core/tensor.o $(BUILD_DIR)/nn/core/utils.o $(BUILD_DIR)/nn/core/init.o $(BUILD_DIR)/nn/core/layer_grad.o $(BUILD_DIR)/nn/dataset/dataloader.o $(BUILD_DIR)/nn/layers/conv2D.o $(BUILD_DIR)/nn/layers/linear.o $(BUILD_DIR)/nn/layers/maxpool2D.o $(BUILD_DIR)/nn/layers/dropout.o $(BUILD_DIR)/nn/layers/dropout2D.o $(BUILD_DIR)/nn/layers/cross_entropy_loss.o $(BUILD_DIR)/nn/nn/adamW.o $(BUILD_DIR)/nn/nn/step_lr_scheduler.o $(BUILD_DIR)/nn/nn/relu.o $(BUILD_DIR)/image/image.o
	@echo "Linking optimized train $@..."
	$(CC) $^ -o $@ $(TRAIN_LDFLAGS)
	@echo "Optimized train build successful! Binary: $@"

$(INFERENCE_TARGET): $(BUILD_DIR)/nn/inference.o $(BUILD_DIR)/nn/CNN.o $(BUILD_DIR)/nn/core/tensor.o $(BUILD_DIR)/nn/core/utils.o $(BUILD_DIR)/nn/core/init.o $(BUILD_DIR)/nn/core/layer_grad.o $(BUILD_DIR)/nn/layers/conv2D.o $(BUILD_DIR)/nn/layers/linear.o $(BUILD_DIR)/nn/layers/maxpool2D.o $(BUILD_DIR)/nn/layers/dropout.o $(BUILD_DIR)/nn/layers/dropout2D.o $(BUILD_DIR)/nn/layers/cross_entropy_loss.o $(BUILD_DIR)/nn/nn/adamW.o $(BUILD_DIR)/nn/nn/step_lr_scheduler.o $(BUILD_DIR)/nn/nn/relu.o $(BUILD_DIR)/image/image.o $(BUILD_DIR)/image/operations.o
