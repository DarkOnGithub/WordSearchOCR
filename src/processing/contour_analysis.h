...
/**
 * Filter contours that could represent letters based on area and aspect ratio criteria.
 * Criteria: 20 < area < 5000, 0.3 < w/h < 3.0, w > 8, h > 8
 ...
 * Tries the target position first, then shifts up/down or left/right within max_offset.
 * @return Safe position that doesn't overlap letters, or original target_pos if none found
 */
