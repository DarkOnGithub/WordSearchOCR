...
/**
 * Determine if the grid has proper grid lines that require line-based cell
 * detection. This is done by detecting horizontal and vertical lines that span
 * nearly the full width/height.
 * @return 1 if proper grid lines detected (use line detection), 0 if not (use
