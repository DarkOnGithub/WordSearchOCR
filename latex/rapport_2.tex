...
\begin{itemize}
    ...
    \item \textbf{Rotation automatique de l'image :} Léa-Angélina Kolmerschlag
    ...
    \item \textbf{Réseau de neurones (XNOR):} Tom Huynh et Hugo Guyennet
    \item \textbf{Réseau de neurones (OCR):} Tom Huynh
    \item \textbf{Entrainement du réseau de neurones (OCR) et jeu de données :} Tom Huynh et Hugo Guyennet
...
\newpage
\input{sections/automatic_rotation}
\newpage
